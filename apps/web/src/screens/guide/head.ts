...
export const guideHead = (guide: GuideHeadData, country: CountryCode): PageHeadProps => ({
  ...
  path: (locale) => paths.guide({ locale, origin: null, country, place: null, status: null, situation: null, work: null }, guide.slug),
...
export const guideData = (
  ...
  const area = absolute(guideArea(guide.place, { locale, origin: null, country, place: null, status: null, situation: null, work: null }), origin)
