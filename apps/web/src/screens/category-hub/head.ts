...
export const categoryHubHead = (hub: CategoryHubHeadData, country: CountryCode, name: string): PageHeadProps => ({
  ...
  path: (locale) => paths.categoryHub({ locale, origin: null, country, place: null, status: null, situation: null, work: null }, hub.goalSlug, hub.slug),
...
export const categoryHubData = (
  ...
  const journey = { locale, origin: null, country, place: null, status: null, situation: null, work: null }
