...
export const DECLARED: readonly Declared[] = [
  ...
  // Figma 16:32. The label and helper sit on the page; the value and
  // placeholder sit in the field.
  { role: 'an input label', fore: 'textPrimary', back: 'background', target: 4.5, painted: { by: 'field', part: 'label' } },
  { role: 'an input value', fore: 'textPrimary', back: 'surface', target: 4.5, painted: { by: 'field', part: 'value' } },
  { role: 'an input placeholder', fore: 'textSecondary', back: 'surface', target: 4.5, painted: { by: 'field', part: 'placeholder' } },
  { role: 'an input helper', fore: 'textSecondary', back: 'background', target: 4.5, painted: { by: 'field', part: 'helper' } },
